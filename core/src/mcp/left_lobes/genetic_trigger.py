...
from mcp.genetic_trigger_system.neural_genetic_processor import NeuralGeneticProcessor
from mcp.genetic_trigger_system.code_genetic_processor import CodeGeneticProcessor
